...
The gem allows you to update content as it flows back to browser.  This can be useful in certain cases.  For instance lets say you have an app plus a blog hosted on [Wordpress.com](http://Wordpress.com) or [tumblr](http://www.tumblr.com) that you want to serve in the URL namespace for your app.  But the pages coming from blog server will have URLs like xxx.wordpress.com/category/post which you rather be http://<your app URL>/blog/category/post.
